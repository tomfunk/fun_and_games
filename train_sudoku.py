...
# )
# model.learn(total_timesteps=10000000, tb_log_name='PPO_1', eval_freq=1000, n_eval_episodes=10)
# model.save('su1_ppo')

model = PPO.load('su1_ppo', env=many_env, tensorboard_log="./ppo_sudoku_tensorboard/")
model.learn(total_timesteps=10000000, reset_num_timesteps=False, tb_log_name='PPO_1')
model.save('su1_ppo')
